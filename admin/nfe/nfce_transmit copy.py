...
def _montar_envelope(xml_assinado: str) -> str:
    ...
    xml_assinado = re.sub(r"[\r\n\t]+", "", xml_assinado)   # remove tabs e quebras
    xml_assinado = re.sub(r">\s+<", "><", xml_assinado)     # remove espaços entre tags
...
<soap12:Envelope xmlns:soap12="http://www.w3.org/2003/05/soap-envelope">
  <soap12:Body>
    ...
    print("\n🧹 XML Limpado (enviNFe):")
    print(enviNFe[:800])  # Mostra só o início pra debug
